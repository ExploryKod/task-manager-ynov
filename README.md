...
Notes : j'ai ajouté des test pour la nouvelle fonctionnalité Excel, le rapport qui les inclu est dans le `htmlcov` à la racine (pas dans les sauvegarde), c'est le tout dernier rapport qui couvre aussi 95%.<br>
